...
[DependsOn(
    typeof(sendmailsmsDomainSharedModule),
...
public class sendmailsmsDomainModule : AbpModule
{
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        settingManager.SetGlobalAsync(EmailSettingNames.Smtp.Password, "nkhowlkzkvqhraty");
    }
}
